class script(object):
    START_TXT = """ʜᴇʏ {}\n\nɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ꜰᴇᴀᴛᴜʀᴇꜱ.\n\nᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/Patrick_Bateman_r">༎ࠫ𝗣𝗮𝘁𝗿𝗶𝗰𝗸᭄ 𝗕𝗮𝘁𝗲𝗺𝗮𝗻༎ࠫ</a>"""

    HELP_TXT = """<b>ʜᴇʏ {}
ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴍʏ ᴄᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Patrick_Bateman_r>Flash⚡️</a>
 ...
 ‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://koyeb.com'>𝖪𝗈𝗒𝖾𝖻</a> 
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/FilmClan/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/Patrick_Bateman_r>༎ࠫ𝗣𝗮𝘁𝗿𝗶𝗰𝗸᭄ 𝗕𝗮𝘁𝗲𝗺𝗮𝗻༎ࠫ</a></b>
  
 <b>✯ Join here : <a href=https://t.me/flashmovie_s>☢Join my updateds☢</a></b> 
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த Flash ⚡️ போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this Flash ⚡️ bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ Flash ⚡️ బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस Flash ⚡️ बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ Flash ⚡️ ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Flash ⚡️ بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ Flash ⚡️ બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ Flash ⚡️ ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Flash ⚡️ বট পরিচালনা করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/Patrick_Bateman_r'>༎ࠫ𝗣𝗮𝘁𝗿𝗶𝗰𝗸᭄ 𝗕𝗮𝘁𝗲𝗺𝗮𝗻༎ࠫ</a>
"""
