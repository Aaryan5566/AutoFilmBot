...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002373762249')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002373762249')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002373762249'))
...
URL = "https://related-emeline-flashpoint-ad6d3f5e.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://related-emeline-flashpoint-ad6d3f5e.koyeb.app/".format(FQDN, PORT)
