...
PICS = (environ.get('PICS', 'https://graph.org/file/209a1d6fe3050c7b09474.jpg')).split()
...
URL = "https://autofilmbot-po0e.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-po0e.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-po0e.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-po0e.onrender.com/".format(FQDN)
