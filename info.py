...
BOT_TOKEN = environ.get('BOT_TOKEN', "7371099584:AAGXeRDvQIAxOJ3Oi5rjpDiNQE8hUxcn9CE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002427767556').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002427767556'))
...
QUALITIES = ["240P", "360P", "480P", "640P", "720P", "1080P", "1280P", "1440P", "1920P", "2160P", "3840P"]

EPISODES = ["E01", "E02", "E03", "E04", "E05", "E06", "E07", "E08", "E09", "E010", "E011", "E012", "E013", "E014", "E015", "E016", "E017", "E018", "E019", "E020", "E021", "E022", "E023", "E024", "E025", "E026", "E027", "E028", "E029", "E030", "E031", "E032", "E033", "E034", "E035", "E036", "E037", "E038", "E039", "E040", "E041", "E042", "E043", "E044", "E045", "E046", "E047", "E048", "E049", "E050"]
...
URL = "https://mixed-laurianne-flashpoint-f3f0ec98.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mixed-laurianne-flashpoint-f3f0ec98.koyeb.app/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'MYD-BOY'))
MULTI_CLIENT = False
name = str(environ.get('name', 'FILMCLAN'))
