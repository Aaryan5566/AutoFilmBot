...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAIFzWYEz9iaXjt3iLNpgrUzame_bi3IAAIgAwACKHaAVR_daUuW72SGHgQ") 
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            ...
            photo="https://graph.org/file/3e4e7cff20722c6f2cbd8.jpg",
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Group, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink omegalinks.in 4b392f8eb6ad711fbe58\n\nThat's it!!! Enjoy Earning Money 💲\n\n[ Trusted Earning Site - https://omegalinks.in]\n\nIf you have any Doubts, Feel Free to Ask me - @Maidi_King\n\n(Puriyala na intha contact la message pannunga - @Maidi_King)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink omegalinks.in 4b392f8eb6ad711fbe58</code></b>")
